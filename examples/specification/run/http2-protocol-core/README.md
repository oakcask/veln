...
Migration history and the final independent verification routes are preserved
in the
[implemented proposal record](../../../../docs/reference/implemented-proposals/http2-standard-library-completion-and-fixture-retirement.md).
