...
const QUALIFIED_SYMBOLS: &[StandardSymbolDescriptor] = &[
    ...
    runtime_symbol(
        ...
        "spawn_with32",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with32",
    ),
    runtime_symbol(
        "task",
        "spawn_with33",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with33",
    ),
    runtime_symbol(
        "task",
        "spawn_with34",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with34",
    ),
    runtime_symbol(
        "task",
        "spawn_with35",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with35",
    ),
    runtime_symbol(
        "task",
        "spawn_with36",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with36",
    ),
    runtime_symbol(
        "task",
        "spawn_with37",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with37",
    ),
    runtime_symbol(
        "task",
        "spawn_with38",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with38",
    ),
    runtime_symbol(
        "task",
        "spawn_with39",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with39",
    ),
    runtime_symbol(
        "task",
        "spawn_with40",
        CONCURRENCY_EFFECTS,
        "runtime.task.spawn_with40",
    ),
...
source_prelude_symbol_set! {
    ...
    "flag40be_is_set" => veln_stdlib::prelude_source("flag40be_is_set"),
    "flag40be_set" => veln_stdlib::prelude_source("flag40be_set"),
    "flag40be_bits" => veln_stdlib::prelude_source("flag40be_bits"),
    "flag40be_from_bits" => veln_stdlib::prelude_source("flag40be_from_bits"),
    "flag40le_is_set" => veln_stdlib::prelude_source("flag40le_is_set"),
    "flag40le_set" => veln_stdlib::prelude_source("flag40le_set"),
    "flag40le_bits" => veln_stdlib::prelude_source("flag40le_bits"),
    "flag40le_from_bits" => veln_stdlib::prelude_source("flag40le_from_bits"),
    "flag48be_is_set" => veln_stdlib::prelude_source("flag48be_is_set"),
    "flag48be_set" => veln_stdlib::prelude_source("flag48be_set"),
    "flag48be_bits" => veln_stdlib::prelude_source("flag48be_bits"),
    "flag48be_from_bits" => veln_stdlib::prelude_source("flag48be_from_bits"),
    "flag48le_is_set" => veln_stdlib::prelude_source("flag48le_is_set"),
    "flag48le_set" => veln_stdlib::prelude_source("flag48le_set"),
    "flag48le_bits" => veln_stdlib::prelude_source("flag48le_bits"),
    "flag48le_from_bits" => veln_stdlib::prelude_source("flag48le_from_bits"),
    "flag56be_is_set" => veln_stdlib::prelude_source("flag56be_is_set"),
    "flag56be_set" => veln_stdlib::prelude_source("flag56be_set"),
    "flag56be_bits" => veln_stdlib::prelude_source("flag56be_bits"),
    "flag56be_from_bits" => veln_stdlib::prelude_source("flag56be_from_bits"),
    "flag56le_is_set" => veln_stdlib::prelude_source("flag56le_is_set"),
    "flag56le_set" => veln_stdlib::prelude_source("flag56le_set"),
    "flag56le_bits" => veln_stdlib::prelude_source("flag56le_bits"),
    "flag56le_from_bits" => veln_stdlib::prelude_source("flag56le_from_bits"),
