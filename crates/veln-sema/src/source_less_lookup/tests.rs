...
const PRELUDE_SYMBOL_WITH_CONTEXTUAL_LITERAL_LEAF: &[StandardSymbolDescriptor] =
    &[StandardSymbolDescriptor {
        module: None,
        name: "true",
        name_class: SourceLessNameClass::Function,
...
const PUBLIC_COMPILER_ADAPTER_WITH_CONTEXTUAL_LITERAL_LEAF: &[StandardSymbolDescriptor] =
    &[StandardSymbolDescriptor {
        module: None,
        name: "false",
        name_class: SourceLessNameClass::Function,
