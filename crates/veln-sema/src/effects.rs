...
fn task_signature(
    ...
    match name {
        ...
        "spawn_with23" => task_spawn_with_n_signature(23, expected, handle_type, explicit_item),
        "spawn_with24" => task_spawn_with_n_signature(24, expected, handle_type, explicit_item),
        "spawn_with25" => task_spawn_with_n_signature(25, expected, handle_type, explicit_item),
        "spawn_with26" => task_spawn_with_n_signature(26, expected, handle_type, explicit_item),
        "spawn_with27" => task_spawn_with_n_signature(27, expected, handle_type, explicit_item),
        "spawn_with28" => task_spawn_with_n_signature(28, expected, handle_type, explicit_item),
        ...
        "spawn_with33" => task_spawn_with_n_signature(33, expected, handle_type, explicit_item),
        "spawn_with34" => task_spawn_with_n_signature(34, expected, handle_type, explicit_item),
        "spawn_with35" => task_spawn_with_n_signature(35, expected, handle_type, explicit_item),
        "spawn_with36" => task_spawn_with_n_signature(36, expected, handle_type, explicit_item),
        "spawn_with37" => task_spawn_with_n_signature(37, expected, handle_type, explicit_item),
        "spawn_with38" => task_spawn_with_n_signature(38, expected, handle_type, explicit_item),
        "spawn_with39" => task_spawn_with_n_signature(39, expected, handle_type, explicit_item),
        "spawn_with40" => task_spawn_with_n_signature(40, expected, handle_type, explicit_item),
...
fn core_task_signature(
    ...
    match name {
        ...
        "spawn_with23" => {
            core_task_spawn_with_n_signature(23, expected, handle_type, explicit_item)
        }
        "spawn_with24" => {
            core_task_spawn_with_n_signature(24, expected, handle_type, explicit_item)
        }
        "spawn_with25" => {
            core_task_spawn_with_n_signature(25, expected, handle_type, explicit_item)
        }
        "spawn_with26" => {
            core_task_spawn_with_n_signature(26, expected, handle_type, explicit_item)
        }
        "spawn_with27" => {
            core_task_spawn_with_n_signature(27, expected, handle_type, explicit_item)
        }
        "spawn_with28" => {
            core_task_spawn_with_n_signature(28, expected, handle_type, explicit_item)
        }
        "spawn_with29" => {
            core_task_spawn_with_n_signature(29, expected, handle_type, explicit_item)
        }
        "spawn_with30" => {
            core_task_spawn_with_n_signature(30, expected, handle_type, explicit_item)
        }
        "spawn_with31" => {
        ...
        "spawn_with33" => {
            core_task_spawn_with_n_signature(33, expected, handle_type, explicit_item)
        }
        "spawn_with34" => {
            core_task_spawn_with_n_signature(34, expected, handle_type, explicit_item)
        }
        "spawn_with35" => {
            core_task_spawn_with_n_signature(35, expected, handle_type, explicit_item)
        }
        "spawn_with36" => {
            core_task_spawn_with_n_signature(36, expected, handle_type, explicit_item)
        }
        "spawn_with37" => {
            core_task_spawn_with_n_signature(37, expected, handle_type, explicit_item)
        }
        "spawn_with38" => {
            core_task_spawn_with_n_signature(38, expected, handle_type, explicit_item)
        }
        "spawn_with39" => {
            core_task_spawn_with_n_signature(39, expected, handle_type, explicit_item)
        }
        "spawn_with40" => {
            core_task_spawn_with_n_signature(40, expected, handle_type, explicit_item)
        }
