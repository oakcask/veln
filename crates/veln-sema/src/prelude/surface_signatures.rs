use super::{
    byte_signatures::prelude_byte_signature, expected_types::ExpectedPreludeParts,
    source_signatures::compiler_adapter_callback_signature,
};
use crate::adt::type_operations as adt;
use crate::semantic_model::Type;
use crate::standard_symbols::StandardSymbolDescriptor;

pub(super) fn surface_prelude_signature(
