...
fn generated_format_neutral_schema_decode_helpers_reject_unsupported_field_types() {
    ...
    assert_eq!(
        diagnostic.message,
        "format-neutral schema field `items` cannot expose a generated decode helper because `Option<List<Int>>` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type"
    );
...
fn generated_format_neutral_schema_decode_helpers_reject_unsupported_dict_shapes() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "  flag_scores: Dict<String, Bool>\n",
            "  optional_scores: Option<Dict<String, Int>>\n",
            "  nested_scores: {scores: Dict<String, Int>}\n",
            "end\n",
        ),
    );
    let parsed = parse(&source);
    ...
    assert_eq!(
        messages,
        vec![
            "format-neutral schema field `numeric_scores` cannot expose a generated decode helper because `Dict<Int, Int>` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type",
            "format-neutral schema field `flag_scores` cannot expose a generated decode helper because `Dict<String, Bool>` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type",
            "format-neutral schema field `optional_scores` cannot expose a generated decode helper because `Option<Dict<String, Int>>` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type",
            "format-neutral schema field `nested_scores` cannot expose a generated decode helper because `{ scores : Dict<String, Int> }` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type",
        ]
    );
}
...
fn generated_format_neutral_schema_decode_helpers_reject_option_inside_record_fields() {
    ...
    assert_eq!(
        diagnostic.message,
        "format-neutral schema field `metadata` cannot expose a generated decode helper because `{ maybe_code : Option<Int> }` is not a supported scalar, top-level List<Int>, List<Bool>, List<Float>, or List<String>, top-level Dict<String, Int> or Dict<String, String>, Option, or record-shaped field type"
    );
}
...
fn infers_prelude_helper_calls_from_expected_types() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "invalid_payload_http2: Result<(), RuntimeDiagnostic>, invalid_window_update_increment_http2: Result<(), RuntimeDiagnostic>, ",
