...
fn generated_schema_encode_helpers_resolve_for_exact_width_binary_schemas() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "end\n",
            "\n",
            "pub fn main(packet: {short_value: Int, little_length: Int, stream_id: Int, little_stream_id: Int, little_wide: Int, wide_value: Int, trace_id: Int, little_trace_id: Int, extended_value: Int, little_extended: Int, massive_value: Int, little_massive: Int}) -> Result<ByteChunk, EncodeError>\n",
    ...
    assert!(matches!(
        ...
        veln_ir::IrSchemaDecodeMappingExpr::Converter { function, arg, .. }
            if function == "next_kind"
                && matches!(
                    arg.as_ref(),
                    veln_ir::IrSchemaDecodeMappingExpr::Field(field) if field == "wire_kind"
                )
    ));
}
...
fn infers_prelude_helper_calls_from_expected_types() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "flags16le: Flag16le, flags32: Flag32be, flags32le: Flag32le, ",
            ...
            "invalid_payload_http2: Result<(), String>, invalid_data_padding_http2: Result<(), String>, ",
            ...
            "ascii_text: byte_chunk_to_visible_ascii_string(chunk), taken: byte_take(chunk, count), ",
            ...
            "write_u32: byte_write_u32_be(1), write_u64: byte_write_u64_be(1), ",
            "write_u16_le: byte_write_u16_le(1), ",
            "write_u24_le: byte_write_u24_le(1), write_u31_le: byte_write_u31_le(1), ",
            "write_u32_le: byte_write_u32_le(1), write_u64_le: byte_write_u64_le(1), ",
