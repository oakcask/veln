...
#[test]
fn generated_schema_encode_helpers_accept_ordered_selected_mapped_value_records() {
    let source = SourceFile::new(
        "main.veln",
        concat!(
            "type Packet\n",
...
#[test]
fn generated_schema_encode_helpers_reject_boolean_selected_mapped_value_records() {
    let source = SourceFile::new(
        "main.veln",
        concat!(
            "type Packet\n",
            ...
            "  value: UInt8\n",
            "\n",
            "  map to Packet when kind == 1 or kind == 2\n",
            "    kind = kind\n",
            "    value = value\n",
            "\n",
            "  map to Packet when kind >= 5\n",
    ...
    assert!(
        lowered
            .diagnostics
            .iter()
            .any(|diagnostic| diagnostic.message.contains("byte_encode_packet_wire")),
        "{:#?}",
        lowered.diagnostics
    );
}
...
#[test]
fn generated_schema_encode_helpers_accept_mapped_arithmetic_records() {
    let source = SourceFile::new(
        "main.veln",
        concat!(
            "type Packet\n",
            ...
            "end\n",
            "\n",
            "pub fn main(packet: {body_length: Int, padded_length: Int, trimmed_length: Int}) -> Result<ByteChunk, EncodeError>\n",
            "  byte_encode_packet_wire(packet)\n",
            "end\n",
        ),
    );
...
#[test]
fn derived_codec_encode_resolves_mapped_arithmetic_schema_encode_step_boundary() {
    let source = SourceFile::new(
        "main.veln",
        concat!(
            "type Packet\n",
            ...
            "end\n",
            "\n",
            "pub fn main(packet: {body_length: Int, padded_length: Int, trimmed_length: Int}) -> EncodeStep<()>\n",
            "  PacketCodec(packet)\n",
            "end\n",
        ),
    );
...
#[test]
fn generated_schema_decode_helpers_keep_five_argument_converter_mapping_expressions() {
    let source = SourceFile::new(
        "main.veln",
        concat!(
            "type Header\n",
            ...
            "end\n",
            "\n",
            "fn combine(input: {value: Int}, extra: Int, another: Int, final: Int, doubled: Int) -> Int\n",
            "  input.value + extra + another + final + doubled\n",
            "end\n",
            "\n",
            "schema HeaderWire\n",
            "  format binary\n",
            ...
            "\n",
            "  map to Header\n",
            "    summary = combine({value: wire_kind}, wire_length - 1, wire_kind + 1, wire_length + wire_kind, wire_length * 2)\n",
            "end\n",
            "\n",
            "pub fn main(view: ByteView) -> Result<{summary: Int}, String>\n",
            "  byte_decode_header_wire(view)\n",
...
#[test]
fn generated_schema_decode_helpers_keep_imported_five_argument_converter_mapping_expressions() {
    let app_source = SourceFile::new(
        "app.veln",
        concat!(
            "mod app\n",
            ...
            "\n",
            "  map to Header\n",
            "    summary = helpers::combine({value: wire_kind}, wire_length, wire_kind + 1, wire_length + wire_kind, wire_length * 2)\n",
            "end\n",
            "\n",
            "pub fn main(view: ByteView) -> Result<{summary: Int}, String>\n",
            "  byte_decode_header_wire(view)\n",
    ...
    let helpers_source = SourceFile::new(
        ...
        concat!(
            "mod helpers\n",
            "pub fn combine(input: {value: Int}, extra: Int, another: Int, final: Int, doubled: Int) -> Int\n",
            "  input.value + extra + another + final + doubled\n",
            "end\n",
        ),
    );
