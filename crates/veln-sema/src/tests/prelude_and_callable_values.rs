...
fn generated_schema_encode_helpers_resolve_for_exact_width_binary_schemas() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "end\n",
            "\n",
            "pub fn main(packet: {short_value: Int, little_length: Int, stream_id: Int, little_stream_id: Int, little_wide: Int, wide_value: Int, extended_value: Int, little_extended: Int, massive_value: Int, little_massive: Int}) -> Result<ByteChunk, EncodeError>\n",
