...
fn infers_prelude_helper_calls_from_expected_types() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "count: ByteCount, offset: ByteOffset, ",
            ...
            "appended: byte_append(chunk, other_chunk), taken: byte_take(chunk, count), ",
            "dropped: byte_drop(chunk, count), count_value: byte_count(1), ",
