...
fn infers_prelude_helper_calls_from_expected_types() {
    let source = SourceFile::new(
        ...
        concat!(
            ...
            "flow_control_http2: Result<(), String>, concurrent_streams_http2: Result<(), String>, ",
            ...
            "partial_preface_http2: http2_protocol_partial_preface(0, 6), ",
            "invalid_preface_http2: http2_protocol_invalid_preface(4, 42, 43, 4), ",
            ...
            "concurrent_streams_http2: http2_peer_limit_concurrent_streams_exceeded(0, 2, 1, 3, \"idle-stream\", \"local_configuration\", \"peer_created_stream_limit\"), ",
