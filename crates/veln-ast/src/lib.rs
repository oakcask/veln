...
pub use model::{
    ...
    EffectOperationDecl, Expr, ExprKind, Function, FunctionKind, HandlerDecl, HandlerProviderDecl,
    IfBranch, MatchArm, ModuleHeader, NodeId, Param, Pattern, PatternField, PatternKind, PrefixOp,
    PublicAlias, PublicAliasKind, RecordField, ResultBinding, SatisfyClause, SchemaDecl,
