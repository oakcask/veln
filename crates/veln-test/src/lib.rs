...
mod tests {
    ...
    fn concurrent_streams_protocol_diagnostic_result_trace_keeps_value_details() {
        let trace = concat!(
            "result\t",
            "485454502f3220636f6e63757272656e742073747265616d206c696d69742065786365656465642061742062797465206f66667365742030",
            "\tprotocol_diagnostic\thttp2.peer_limit.concurrent_streams_exceeded\t0",
            "\t7\tobserved_open_stream_count\tnumber\t2",
            "\tallowed_max_concurrent_streams\tnumber\t1",
            "\tstream_id\tnumber\t3",
            "\tstream_ref\tstring\t73747265616d",
            "\tactive_state\tstring\t69646c652d73747265616d",
            "\treceive_limit_provenance\tstring\t6c6f63616c5f636f6e66696775726174696f6e",
            "\trule_provenance\tstring\t706565725f637265617465645f73747265616d5f6c696d6974\n",
        );
        ...
        assert_eq!(
            ...
            concat!(
                "{\"kind\":\"result\",\"phase\":\"runtime\",",
                "\"value\":\"HTTP/2 concurrent stream limit exceeded at byte offset 0\",",
                "\"protocol_diagnostic\":{\"kind\":\"protocol_diagnostic\",",
                "\"id\":\"http2.peer_limit.concurrent_streams_exceeded\",",
                "\"byte_offset\":{\"kind\":\"ByteOffset\",\"value\":0},",
                "\"observed_open_stream_count\":2,",
                "\"allowed_max_concurrent_streams\":1,",
                "\"stream_id\":3,",
                "\"stream_ref\":\"stream\",",
                "\"active_state\":\"idle-stream\",",
                "\"receive_limit_provenance\":\"local_configuration\",",
                "\"rule_provenance\":\"peer_created_stream_limit\"}}"
            )
        );
    }
