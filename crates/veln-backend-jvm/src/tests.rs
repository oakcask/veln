...
#[test]
fn bytecode_backend_runs_twenty_three_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String) -> String effects [concurrency]\n",
        "  twenty_third\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with23(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg23", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-three\n");
}

#[test]
fn bytecode_backend_runs_twenty_four_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String, twenty_fourth: String) -> String effects [concurrency]\n",
        "  twenty_fourth\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with24(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg24", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-four\n");
}

#[test]
fn bytecode_backend_runs_twenty_five_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with25(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg25", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-five\n");
}

#[test]
fn bytecode_backend_runs_twenty_six_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String, twenty_fourth: String, twenty_fifth: String, twenty_sixth: String) -> String effects [concurrency]\n",
        "  twenty_sixth\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with26(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg26", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-six\n");
}
...
#[test]
fn bytecode_backend_runs_twenty_eight_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String, twenty_fourth: String, twenty_fifth: String, twenty_sixth: String, twenty_seventh: String, twenty_eighth: String) -> String effects [concurrency]\n",
        "  twenty_eighth\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with28(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg28", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-eight\n");
}

#[test]
fn bytecode_backend_runs_twenty_nine_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String, twenty_fourth: String, twenty_fifth: String, twenty_sixth: String, twenty_seventh: String, twenty_eighth: String, twenty_ninth: String) -> String effects [concurrency]\n",
        "  twenty_ninth\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with29(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg29", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "twenty-nine\n");
}

#[test]
fn bytecode_backend_runs_thirty_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with30(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg30", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty\n");
}

#[test]
fn bytecode_backend_runs_thirty_one_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with31(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg31", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-one\n");
}

#[test]
fn bytecode_backend_runs_thirty_two_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with32(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg32", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-two\n");
}

#[test]
fn bytecode_backend_runs_thirty_three_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with33(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg33", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-three\n");
}

#[test]
fn bytecode_backend_runs_thirty_four_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with34(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg34", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-four\n");
}

#[test]
fn bytecode_backend_runs_thirty_five_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with35(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\", \"thirty-five\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg35", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-five\n");
}

#[test]
fn bytecode_backend_runs_thirty_six_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with36(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\", \"thirty-five\", \"thirty-six\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg36", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-six\n");
}

#[test]
fn bytecode_backend_runs_thirty_seven_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with37(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\", \"thirty-five\", \"thirty-six\", \"thirty-seven\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg37", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-seven\n");
}

#[test]
fn bytecode_backend_runs_thirty_eight_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        ...
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with38(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\", \"thirty-five\", \"thirty-six\", \"thirty-seven\", \"thirty-eight\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg38", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-eight\n");
}

#[test]
fn bytecode_backend_runs_thirty_nine_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg39", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "thirty-nine\n");
}

#[test]
fn bytecode_backend_runs_forty_argument_task_function_values_when_java_is_available() {
    let ir = lower_to_ir(concat!(
        "fn last(first: String, second: String, third: String, fourth: String, fifth: String, sixth: String, seventh: String, eighth: String, ninth: String, tenth: String, eleventh: String, twelfth: String, thirteenth: String, fourteenth: String, fifteenth: String, sixteenth: String, seventeenth: String, eighteenth: String, nineteenth: String, twentieth: String, twenty_first: String, twenty_second: String, twenty_third: String, twenty_fourth: String, twenty_fifth: String, twenty_sixth: String, twenty_seventh: String, twenty_eighth: String, twenty_ninth: String, thirtieth: String, thirty_first: String, thirty_second: String, thirty_third: String, thirty_fourth: String, thirty_fifth: String, thirty_sixth: String, thirty_seventh: String, thirty_eighth: String, thirty_ninth: String, fortieth: String) -> String effects [concurrency]\n",
        "  fortieth\n",
        "end\n",
        "pub fn main() -> Result<(), JoinError> effects [stdio, concurrency]\n",
        "  let task = task::spawn_with40(last, \"one\", \"two\", \"three\", \"four\", \"five\", \"six\", \"seven\", \"eight\", \"nine\", \"ten\", \"eleven\", \"twelve\", \"thirteen\", \"fourteen\", \"fifteen\", \"sixteen\", \"seventeen\", \"eighteen\", \"nineteen\", \"twenty\", \"twenty-one\", \"twenty-two\", \"twenty-three\", \"twenty-four\", \"twenty-five\", \"twenty-six\", \"twenty-seven\", \"twenty-eight\", \"twenty-nine\", \"thirty\", \"thirty-one\", \"thirty-two\", \"thirty-three\", \"thirty-four\", \"thirty-five\", \"thirty-six\", \"thirty-seven\", \"thirty-eight\", \"thirty-nine\", \"forty\")\n",
        "  let value: String = task::join(task)?\n",
        "  stdio::println(value)\n",
        "  Ok(())\n",
        "end\n",
    ...
    let Some(output) = run_jvm_program_when_java_is_available("bytecode-task-arg40", &program, &[])
    else {
        return;
    };
    ...
    assert_eq!(String::from_utf8_lossy(&output.stdout), "forty\n");
}
...
fn java_method_name_helpers_map_builtin_surface_names() {
    ...
    for (surface, method) in [
        ...
        ("task::spawn_with23", "taskSpawnWith23"),
        ...
        ("task::spawn_with28", "taskSpawnWith28"),
        ...
        ("task::spawn_with33", "taskSpawnWith33"),
        ("task::spawn_with34", "taskSpawnWith34"),
        ("task::spawn_with35", "taskSpawnWith35"),
        ("task::spawn_with36", "taskSpawnWith36"),
        ("task::spawn_with37", "taskSpawnWith37"),
        ("task::spawn_with38", "taskSpawnWith38"),
        ("task::spawn_with39", "taskSpawnWith39"),
        ("task::spawn_with40", "taskSpawnWith40"),
        ("task::join", "taskJoin"),
