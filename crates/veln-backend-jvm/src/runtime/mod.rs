...
runtime_method_table!(prelude_method, "vecLen", {
    ...
    "http2_protocol_invalid_payload_length_chunk" => "http2ProtocolInvalidPayloadLengthChunk",
    ...
    "hpack_fixture_unsupported_static_index" => "hpackFixtureUnsupportedStaticIndex",
...
pub(crate) fn binary_method(op: BinaryOp) -> &'static str {
    match op {
        ...
        BinaryOp::ShiftRightLogical => "shiftRightLogical",
        BinaryOp::Add => "add",
