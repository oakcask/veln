...
pub use model::{
    ...
    IrSchemaDecodeDispatchCase, IrSchemaDecodeField, IrSchemaDecodeMappingExpr,
    IrSchemaDecodeMappingField, IrSchemaDecodeMappingRecordField, IrSchemaDecodeSpec,
