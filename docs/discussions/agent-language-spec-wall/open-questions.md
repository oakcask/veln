...
- Resolved by [AST Phase Boundary](result-ast-phase-boundary.md): use a
...
- Resolved by [Check JSON Details Fields](result-check-json-details-fields.md):
...
- Resolved by
  [Hole Satisfy Source Syntax](result-hole-satisfy-source-syntax.md): attach
...
- Resolved by [Satisfy Unknown Severity](result-satisfy-unknown-severity.md):
...
- Resolved by
  [Stdio API and Output Events](result-stdio-api-and-output-events.md): provide
...
- Resolved by [Block Structure](result-block-structure.md): first-slice blocks
...
- Resolved by [Compact Function Form](result-compact-function-form.md): named
...
- Resolved by [Pipeline Style](result-pipeline-style.md): pipeline should be
...
- Resolved by [Method Call Boundary](result-method-call-boundary.md): use
...
- Resolved by [Error Type Inference](result-error-type-inference.md): public
...
- Resolved by [Contract Blame Boundary](result-contract-blame-boundary.md):
...
- Resolved by [Effect Declaration Boundary](result-effect-declaration-boundary.md):
...
- Resolved by [Effect Access Modes](result-effect-access-modes.md): first-slice
...
- Resolved by
  [First-Slice Observable I/O](result-first-slice-observable-io.md): first-slice
...
- Resolved by [Named Hole Syntax](result-named-hole-syntax.md): first-slice
...
- Resolved by [Hole Runtime Boundary](result-hole-runtime-boundary.md):
...
- Resolved by [Test JSON Shape](result-test-json-shape.md): `veln test --json`
