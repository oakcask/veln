...
[proposal target queue](../proposals/target-queue.md).
...
- The dictionary part of item 3 is complete as type-system support:
  ...
  [language type reference](../reference/language/types.md).
- `hole.unfilled` includes the required details shape: `phase`, `node_id`,
  ...
  work is tracked in
  [hole reference](../reference/language/holes.md).
...
- Complete: direct stdio calls are recognized as compiler-known effectful
  ...
  [contracts and effects reference](../reference/language/contracts-holes.md).
...
- Complete for comment safety: comment-bearing files are preserved
  ...
  [command reference](../reference/language/commands.md).
...
- Complete for the item 8 gate. Remaining run and runtime targets are tracked in
  [execution reference](../reference/language/execution.md).
...
- Complete for the first-slice same-file example boundary: explicitly targeted
  ...
  is tracked in
  [test JSON reference](../reference/language/test-json.md).
...
- [First-Slice Grammar](../reference/source-decisions/records/result-first-slice-grammar.md)
- [AST Phase Boundary](../reference/source-decisions/records/result-ast-phase-boundary.md)
...
- [First-Slice Prelude Helpers](../reference/source-decisions/records/result-first-slice-prelude-helpers.md)
- [Stdio API and Output Events](../reference/source-decisions/records/result-stdio-api-and-output-events.md)
- [Check JSON Details Fields](../reference/source-decisions/records/result-check-json-details-fields.md)
- [Transitive Effect Diagnostics](../reference/source-decisions/records/result-transitive-effect-diagnostics.md)
- [Contract Predicate Parsing](../reference/source-decisions/records/result-contract-predicate-parsing.md)
- [Hole Satisfy Source Syntax](../reference/source-decisions/records/result-hole-satisfy-source-syntax.md)
