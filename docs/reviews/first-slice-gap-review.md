...
This is the routing page for the first-slice gap review. Use it to decide
whether the current review evidence is relevant before opening the full record.
...
- Use [../reference/source-decisions/README.md](../reference/source-decisions/README.md)
  when you need implemented decision rationale.
