...
- [Hole diagnostics and details](contracts-holes-full.md#holes) defines
  `hole.unfilled`, partial check status, and stable diagnostic detail fields.
- [Repair candidates](contracts-holes-full.md#holes) defines candidate query
  records, ranking, application policy, and safe repair candidates.
- [Satisfy constraints](contracts-holes-full.md#holes) defines `satisfy`
