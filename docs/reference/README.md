...
- Agent language-services lifecycle frozen artifacts:
...
- Use [agent-language-services-lifecycle/README.md](agent-language-services-lifecycle/README.md)
  before changing the frozen agent-language-services source inventory,
  lifecycle manifest, migration-ledger schema, or validator.
