# Veln First-Slice Grammar

Date: 2026-05-24

This is the canonical source grammar for the first Veln slice. It consolidates
the grammar sketch and later grammar updates from the design-wall decisions.
Historical rationale remains in the linked discussion results.

This document describes the language target. It is not, by itself, a claim that
every production is implemented in the current parser.
