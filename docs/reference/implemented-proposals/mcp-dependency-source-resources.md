...
| Listed dependency resources are sorted with other resources and read from retained bytes. | `resources_list_returns_sorted_resource_metadata`, `successful_saved_project_tools_admit_dependency_resources_until_shutdown`, and `dependency-source-resources` |
