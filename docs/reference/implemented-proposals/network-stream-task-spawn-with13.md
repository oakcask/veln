...
This record preserves the completed thirteen-argument stream-handler task slice
...
The completed slice adds `task::spawn_with13` as the thirteen-argument sibling of
`task::spawn_with`, `task::spawn_with2`, `task::spawn_with3`,
`task::spawn_with4`, `task::spawn_with5`, `task::spawn_with6`,
`task::spawn_with7`, `task::spawn_with8`, `task::spawn_with9`,
`task::spawn_with10`, `task::spawn_with11`, and `task::spawn_with12`. It
starts a thirteen-argument callable under the existing `concurrency` effect,
...
context, routing metadata, and nine additional ordinary metadata values as
...
- Auditing why thirteen-argument stream-handler task spawning is no longer
