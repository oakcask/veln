...
update-when: The MCP JSONL equality, length, missing-path, workspace URI, definition-workspace executable MCP case, shared navigation capture evidence, or saved workspace references slice boundary is superseded.
---
