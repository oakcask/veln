...
This record preserves the completed six-argument stream-handler task slice
...
The completed slice adds `task::spawn_with6` as the six-argument sibling of
`task::spawn_with`, `task::spawn_with2`, `task::spawn_with3`,
`task::spawn_with4`, and `task::spawn_with5`. It starts a six-argument
...
context, routing metadata, and two additional ordinary metadata values as
...
- Auditing why six-argument stream-handler task spawning is no longer active
  proposal work.
