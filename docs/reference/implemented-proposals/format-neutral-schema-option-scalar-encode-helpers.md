...
Format-neutral encode helper shapes beyond scalar leaves and `Option<scalar>`
fields, such as `Option<List<Int>>`, remain unsupported and do not expose a
generated helper.
...
helpers beyond scalar leaves and `Option<scalar>` fields, binary schema fields
