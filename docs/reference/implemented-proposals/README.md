...
Superseded or reopened umbrella records are not completion routes. The HTTP/2
sans-I/O protocol-core cleanup is active under
[../../proposals/http2-sans-io-protocol-core.md](../../proposals/http2-sans-io-protocol-core.md);
the historical record remains at
...
- HTTP/2 production outbound HPACK octet values:
  [http2-production-outbound-hpack-octet-values.md](http2-production-outbound-hpack-octet-values.md).
...
- HTTP/2 informational response headers:
  [http2-informational-response-headers.md](http2-informational-response-headers.md).
...
- HTTP/2 HEAD response no-content lifecycle:
  [http2-head-response-no-content-lifecycle.md](http2-head-response-no-content-lifecycle.md).
