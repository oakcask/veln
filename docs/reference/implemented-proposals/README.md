...
- Identifier casing source-less symbols:
  [identifier-casing-source-less-symbols.md](identifier-casing-source-less-symbols.md).
...
- JVM user cache failure recovery:
...
- MCP dependency package-documentation resources:
  [mcp-dependency-package-documentation-resources.md](mcp-dependency-package-documentation-resources.md).
