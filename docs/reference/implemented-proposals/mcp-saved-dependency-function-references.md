...
- `veln-language-service` tests check direct-dependency function selection and
  ...
  occurrences, package identity boundaries, module identity boundaries, local
  binding and field exclusion, and selected-project source boundaries.
- `veln-mcp` server tests check saved-project inference, path, vendor, mirror,
  ...
  unsupported selections, dependency-source capture retry exhaustion, retained
