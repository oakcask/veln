...
eligibility. Shapes such as `Dict<String, Vec<Option<Int>>>`,
`Dict<String, Vec<List<Int>>>`, and non-string dictionary keys remain outside
...
- `../../../examples/specification/check/format-neutral-schema-dict-vec-encode-boundary/`
  checks that `Dict<String, Vec<Option<Int>>>` remains outside the generated
...
- `../../../crates/veln-sema/src/tests/prelude_and_callable_values.rs` checks
  ...
  values plus an adjacent rejected dictionary-vector boundary.
