...
This record preserves the completed eleven-argument stream-handler task slice
...
The completed slice adds `task::spawn_with11` as the eleven-argument sibling of
`task::spawn_with`, `task::spawn_with2`, `task::spawn_with3`,
`task::spawn_with4`, `task::spawn_with5`, `task::spawn_with6`,
`task::spawn_with7`, `task::spawn_with8`, `task::spawn_with9`, and
`task::spawn_with10`. It starts an eleven-argument callable under the existing
...
context, routing metadata, and seven additional ordinary metadata values as
...
- Auditing why eleven-argument stream-handler task spawning is no longer active
  proposal work.
