...
This record describes the completed replacement of the source-visible `FlagN`
family with bitwise operators on `Int`. Current behavior is specified under
`../../specification/`; this file is retained for completion history and
residual-name audits.
