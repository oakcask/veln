...
This slice is complete. It does not add module-identity casing, MCP rename
mapping, or any casing rule for schema-alias targets, schema names, effects,
handlers, operations, fields, type parameters, or holes. Source-less registry
validation is completed separately in
