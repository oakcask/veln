...
checked artifacts. One unique compatible same-source recovery reference can
suppress a derivative unresolved-name diagnostic, but recovery does not cross
