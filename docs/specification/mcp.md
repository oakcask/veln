...
rejection over stdio. It uses `[[mcp_assert]]` response-local checks for
definition payloads, failure payloads, cardinality, and canonical workspace
URIs; the assertion contract is specified by
