...
- Compiler-known calls:
  ...
  additional ordinary metadata value using `task::spawn_with31`, plus a
  thirty-two-argument variant with one additional ordinary metadata value
  using `task::spawn_with32`,
