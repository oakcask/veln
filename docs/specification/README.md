...
- MCP workspace selection, resources, tool schemas, refresh behavior, saved
  diagnostics, and saved navigation:
  [mcp.md](mcp.md).
...
- MCP workspace project inventory, resources, saved diagnostics, and saved
  navigation: [mcp.md](mcp.md).
