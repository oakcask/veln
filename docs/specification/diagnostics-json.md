...
`identifier-casing-exported-source-path-json`. Source-path-derived module
identity isolation from import resolution, duplicate module contents, and
module-cycle policy violations is checked by
`identifier-casing-source-path-import-isolation-json`,
