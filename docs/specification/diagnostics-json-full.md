...
references, validation predicates, dispatch payload eligibility, codec schema
references, and generated helper availability. Schema-level mapping
diagnostics are not current behavior because mapping clauses are rejected by
the parser.
