...
http2_peer_limit_concurrent_streams_exceeded(offset: Int, observed_open_stream_count: Int, allowed_max_concurrent_streams: Int, stream_id: Int, active_state: String, receive_limit_provenance: String, rule_provenance: String) -> Result<(), String>
