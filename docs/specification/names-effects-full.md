...
- source-backed pure helpers: `vec_len`, `vec_is_empty`, `vec_push`,
  `vec_concat`, `dict_contains`, `option_map`, `option_and_then`,
  `option_unwrap_or`, `result_map`, `result_map_err`, and `result_and_then`
- descriptor-only pure helpers: `vec_map`, `vec_filter`, `vec_fold`,
  `vec_try_map`, `vec_try_map_with`, `dict_get`, `dict_insert`,
