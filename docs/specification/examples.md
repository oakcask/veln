...
- Source identifier casing selected-suite static gates, unselected test peer
  ...
  `../../examples/specification/lsp/identifier-casing-source-path-snapshot-navigation/`,
  `../../examples/specification/lsp/identifier-casing-source-path-overlay-navigation/`,
  `../../examples/specification/lsp/identifier-casing-source-path-overlay-reference-filtering/`,
...
- MCP and LSP saved workspace `references` for eligible direct-dependency
  ...
  lookup isolated from a same-spelled type declaration, exclude a workspace type with the alias
...
- MCP saved workspace `references` for visible direct-dependency constructors:
  `../../examples/specification/mcp/references-package-constructor/`.
