...
Huffman symbols rather than a fixed decoded-value allowlist. The example
...
fixture-supported static-symbol decoder. The focused HPACK fixture-codec JSON and
