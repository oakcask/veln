...
intent for `SETTINGS_HEADER_TABLE_SIZE`, `SETTINGS_MAX_FRAME_SIZE`, or
...
last-stream-id and error-code payload, and the maximum valid `UInt31be` stream
id. The source output also matches generated helper
