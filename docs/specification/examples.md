...
ordinary event, state, adapter context, routing metadata, and two additional
ordinary metadata values directly through `task::spawn_with6`, and
...
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn8/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn8-effects/`
cases extend that task boundary to eight ordinary source values with
`task::spawn_with8` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn9/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn9-effects/`
cases extend that task boundary to nine ordinary source values with
`task::spawn_with9` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn10/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn10-effects/`
cases extend that task boundary to ten ordinary source values with
`task::spawn_with10` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn11/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn11-effects/`
cases extend that task boundary to eleven ordinary source values with
`task::spawn_with11` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn12/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn12-effects/`
cases extend that task boundary to twelve ordinary source values with
`task::spawn_with12` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn13/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn13-effects/`
cases extend that task boundary to thirteen ordinary source values with
`task::spawn_with13` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn14/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn14-effects/`
cases extend that task boundary to fourteen ordinary source values with
`task::spawn_with14` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn15/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn15-effects/`
cases extend that task boundary to fifteen ordinary source values with
`task::spawn_with15` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn16/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn16-effects/`
cases extend that task boundary to sixteen ordinary source values with
`task::spawn_with16` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn17/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn17-effects/`
cases extend that task boundary to seventeen ordinary source values with
`task::spawn_with17` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn18/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn18-effects/`
cases extend that task boundary to eighteen ordinary source values with
`task::spawn_with18` while preserving the same socket ownership and effect
boundary.
The
...
cases extend that task boundary to nineteen ordinary source values with
`task::spawn_with19` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn20/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn20-effects/`
cases extend that task boundary to twenty ordinary source values with
`task::spawn_with20` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn21/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn21-effects/`
cases extend that task boundary to twenty-one ordinary source values with
`task::spawn_with21` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn22/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn22-effects/`
cases extend that task boundary to twenty-two ordinary source values with
`task::spawn_with22` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn23/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn23-effects/`
cases extend that task boundary to twenty-three ordinary source values with
`task::spawn_with23` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn24/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn24-effects/`
cases extend that task boundary to twenty-four ordinary source values with
`task::spawn_with24` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn25/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn25-effects/`
cases extend that task boundary to twenty-five ordinary source values with
`task::spawn_with25` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn26/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn26-effects/`
cases extend that task boundary to twenty-six ordinary source values with
`task::spawn_with26` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn27/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn27-effects/`
cases extend that task boundary to twenty-seven ordinary source values with
`task::spawn_with27` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn28/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn28-effects/`
cases extend that task boundary to twenty-eight ordinary source values with
`task::spawn_with28` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn29/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn29-effects/`
cases extend that task boundary to twenty-nine ordinary source values with
`task::spawn_with29` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn30/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn30-effects/`
cases extend that task boundary to thirty ordinary source values with
`task::spawn_with30` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn31/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn31-effects/`
cases extend that task boundary to thirty-one ordinary source values with
`task::spawn_with31` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn32/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn32-effects/`
cases extend that task boundary to thirty-two ordinary source values with
`task::spawn_with32` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn33/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn33-effects/`
cases extend that task boundary to thirty-three ordinary source values with
`task::spawn_with33` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn34/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn34-effects/`
cases extend that task boundary to thirty-four ordinary source values with
`task::spawn_with34` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn35/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn35-effects/`
cases extend that task boundary to thirty-five ordinary source values with
`task::spawn_with35` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn36/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn36-effects/`
cases extend that task boundary to thirty-six ordinary source values with
`task::spawn_with36` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn37/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn37-effects/`
cases extend that task boundary to thirty-seven ordinary source values with
`task::spawn_with37` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn38/` and
`../../examples/specification/check/socket-stream-adapter-routing-spawn38-effects/`
cases extend that task boundary to thirty-eight ordinary source values with
`task::spawn_with38` while preserving the same socket ownership and effect
boundary.
The
`../../examples/specification/run/socket-stream-adapter-routing-spawn39/` and
