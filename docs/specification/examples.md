...
- Source identifier casing run reachability, recovery, import isolation,
  ...
  `../../examples/specification/run/identifier-casing-loaded-dependency-static-gate-json/`,
  `../../examples/specification/run/identifier-casing-unloaded-dependency-boundary-json/`,
