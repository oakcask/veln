...
path or implicit leaf import alias; a written import does not make the imported
schema available as a bare schema path. It does not add package-schema,
schema-alias, module-qualifier, recovery, or rename behavior for schemas. The
