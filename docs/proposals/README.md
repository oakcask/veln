...
- [Binary Schema Primitives And Dispatch](binary-schema-primitives-and-dispatch.md):
  ...
  two-byte, three-byte, four-byte, or five-byte big-endian storage unit,
...
- [HTTP/2 Sans-I/O Protocol Core](http2-sans-io-protocol-core.md): define the
  ...
  and non-visible decoded-byte diagnostics, inbound fixture dynamic-table
  ...
  visible-ASCII fixture string literal decoding and encoding plus the focused
  unsupported-Huffman fixture diagnostics.
- [Network Effect Integration Boundary](network-effect-integration-boundary.md):
  ...
  twenty-six-route channel-first routing, receiver-list cancellable
