...
- [Codec Execution Boundary](codec-execution-boundary.md): define remaining
  ...
  selected structural mapping encode slice.
...
- [Network Effect Integration Boundary](network-effect-integration-boundary.md):
  ...
  accepted-stream lifecycle, and receiver-list seven-route and eight-route
  routing slices documented under `../specification/`; completed proposal
