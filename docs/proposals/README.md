...
- [Binary Schema Primitives And Dispatch](binary-schema-primitives-and-dispatch.md):
  ...
  payload boundary helper, the narrow closed dispatch failure slice, and the
  narrow extension-tolerant dispatch preservation slice.
- [Codec Execution Boundary](codec-execution-boundary.md): define remaining
  ...
  derived codec decode execution boundaries.
- [Schema And Protocol Diagnostics](schema-and-protocol-diagnostics.md):
  ...
  connection-state and stream-state frame-kind protocol projections.
