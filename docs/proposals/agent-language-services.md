...
direct-dependency schema-operation-reference and eligible direct-dependency
...
leaves, `search_docs`, and `read_doc`.
...
- definition lookup beyond the implemented workspace and package-backed symbol
  ...
  direct-dependency public schema aliases, plus paginated reference lookup;
...
implement package schema composition,
...
type-alias, constructor, direct-dependency schema operation, and eligible
direct-dependency schema-alias operation slices remains planned for schema
composition, cross-module and alias-chain schema-alias targets, other dependency
schema-alias scopes, standard-library schemas and schema aliases, transitive
dependencies, pagination, recovery, and casing-neutral references.
