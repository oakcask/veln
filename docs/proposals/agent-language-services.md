...
direct-dependency schema-operation-reference and eligible
...
direct-dependency public schema-operation and eligible schema-alias operation
leaves,
...
constructor, direct-dependency schema-operation, and eligible
...
- package reference lookup for symbol classes other than the implemented
  ...
  type aliases, types, constructors, direct-dependency schema operations, and
  eligible direct-dependency public schema-alias operations,
...
boundary, and direct-dependency schema and schema-alias operation
