...
direct-dependency public schema operation leaves, `search_docs`, and
`read_doc`.
...
- definition lookup beyond the implemented workspace and package-backed symbol
  ...
  constructors and direct-dependency schema operations, plus paginated
  reference lookup;
...
planned for schema composition, cross-module and alias-chain schema-alias
targets, other dependency schema-alias scopes, standard-library schemas and
