...
composition, broader dependency schema-alias references, standard-library
...
- definition lookup beyond the implemented workspace and package-backed symbol
  ...
  constructors and direct-dependency schema operations, including remaining
  dependency and standard-library public schema-alias references, plus
  paginated reference lookup;
- package schema composition, remaining dependency schema-alias reference lookup,
...
planned for schema composition, standard-library schemas, remaining package
schema aliases, transitive dependencies, pagination, recovery, and
casing-neutral references.
