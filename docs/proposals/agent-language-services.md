...
- package reference lookup for symbol classes other than the implemented
  ...
  type aliases, types, constructors, and standard-library schemas;
...
Current direct-dependency schema-alias composition and standard-library schema
composition (but not standard-library schema aliases) is specified by
...
standard-library schema aliases, recovery or casing-neutral navigation,
...
selection before a successful refresh, and a refresh does not remove package
snapshots already published by the server.
