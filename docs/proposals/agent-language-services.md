...
The direct-dependency public type-alias reference slice is implemented and
recorded by
...
and constructor reference search, direct-dependency public function-alias and
type-alias reference search, and standard-library public function-alias
reference search. It does not implement schema, standard-library public
type-alias, public schema-alias, other public-alias, transitive-dependency, or
paginated reference search.
