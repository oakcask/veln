...
Standard-library schema composition and operation references are current
behavior specified under `../specification/` and are not a remaining umbrella
requirement.
...
search, plus standard-library schema composition and operation reference
