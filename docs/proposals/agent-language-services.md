...
direct-dependency schema-operation-reference and
direct-dependency schema-alias-reference slices are
...
direct-dependency public schema operation and schema-alias leaves,
...
schema-alias slices, paginated
references, recovery and casing-neutral reference navigation, package schema
composition and schema-alias references, standard-library schema references,
...
- definition lookup beyond the implemented workspace and package-backed symbol
  ...
  public schema aliases, including broader
  dependency and standard-library public schema-alias references, plus
...
workspace public schema-alias, direct-dependency schema operation, and
direct-dependency public schema-alias reference search are covered by
executable language-service and MCP tests.
...
direct-dependency schema-alias slices remains planned for schema composition,
standard-library schemas and schema aliases, broader dependency schema aliases,
