...
and unchanged. This proposal does not deprecate either target, rewrite existing
call sites, add a generic collection-length protocol, add compiler-known
intrinsics, change byte storage, or implement MCP reference lookup.
