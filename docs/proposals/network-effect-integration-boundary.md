...
- richer channel-first stream event routing beyond the checked two-route,
  three-route, four-route, receiver-list five-route through nineteen-route,
...
- richer per-stream task handling beyond the one-argument, two-argument,
  ...
  twenty-five-argument, twenty-six-argument, twenty-seven-argument, and
  twenty-eight-argument, and twenty-nine-argument spawned handler task shapes
...
The receiver-list five-route through nineteen-route, timeout,
...
- Examples show production adapter socket ownership beyond the first
  ...
  twenty-two-argument, twenty-three-argument, twenty-four-argument,
  twenty-five-argument, twenty-six-argument, twenty-seven-argument, and
  twenty-eight-argument, and twenty-nine-argument spawned handler task, and
