...
- richer channel-first stream event routing beyond the checked two-route,
  three-route, four-route, receiver-list five-route through seventeen-route,
...
- richer per-stream task handling beyond the one-argument, two-argument,
  ...
  twenty-two-argument, twenty-three-argument, twenty-four-argument, and
  twenty-five-argument spawned handler task shapes over ordinary source values
...
The receiver-list five-route through seventeen-route, timeout,
...
- Examples show production adapter socket ownership beyond the first
  ...
  twenty-two-argument, twenty-three-argument, twenty-four-argument, and
  twenty-five-argument spawned handler task, and adapter-level cancellable
  stream routing slices;
