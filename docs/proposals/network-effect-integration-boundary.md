...
- richer channel-first stream event routing beyond the checked two-route,
  three-route, four-route, receiver-list five-route through twenty-seven-route,
...
- richer per-stream task handling beyond the one-argument, two-argument,
  ...
  thirty-four-argument, and thirty-five-argument spawned handler task shapes
...
The receiver-list five-route through twenty-seven-route, timeout,
