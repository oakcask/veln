...
- richer channel-first stream event routing beyond the checked two-route,
  three-route, four-route, receiver-list five-route through twenty-five-route,
...
- richer per-stream task handling beyond the one-argument, two-argument,
  ...
  thirty-four-argument spawned handler task shapes over ordinary source values
...
The receiver-list five-route through twenty-five-route, timeout,
