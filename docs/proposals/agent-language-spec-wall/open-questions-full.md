...
unless you need the detailed inventory.
...
- Resolved by [AST Phase Boundary](../../reference/source-decisions/records/result-ast-phase-boundary.md): use a
...
- Resolved by
  [AST Implementation Representation](../../reference/source-decisions/records/result-ast-implementation-representation.md):
...
- Resolved by [Check JSON Details Fields](../../reference/source-decisions/records/result-check-json-details-fields.md):
  ...
  context.
- Resolved by [Contract Predicate Parsing](../../reference/source-decisions/records/result-contract-predicate-parsing.md):
...
- Resolved by
  [Hole Satisfy Source Syntax](../../reference/source-decisions/records/result-hole-satisfy-source-syntax.md): attach
...
- Resolved by [Satisfy Unknown Severity](../../reference/source-decisions/records/result-satisfy-unknown-severity.md):
  ...
  workflow.
- Resolved by
  [Minimal Project and Test Discovery](../../reference/source-decisions/records/result-minimal-project-test-discovery.md):
  ...
  [Affected Test Selection](../../reference/source-decisions/records/result-affected-test-selection.md), and
  [Module Metadata Location](../../reference/source-decisions/records/result-module-metadata-location.md).
- Resolved by
  [Stdio API and Output Events](../../reference/source-decisions/records/result-stdio-api-and-output-events.md): provide
  four string-only stdio output functions and capture deterministic
  source-linked stdout/stderr events for tests.
- Resolved by
  [Scoping and Name Resolution](../../reference/source-decisions/records/result-scoping-and-name-resolution.md): use
  ...
  resolution.
- Resolved by
  [First-Slice Prelude Helpers](../../reference/source-decisions/records/result-first-slice-prelude-helpers.md): first
...
- Resolved by
  [Prelude Complexity Guarantees](../../reference/source-decisions/records/result-prelude-complexity-guarantees.md):
...
- Resolved by [Block Structure](../../reference/source-decisions/records/result-block-structure.md): first-slice blocks
...
- Resolved by [Compact Function Form](../../reference/source-decisions/records/result-compact-function-form.md): named
...
- Resolved by [Pipeline Style](../../reference/source-decisions/records/result-pipeline-style.md): pipeline should be
...
- Resolved by [Method Call Boundary](../../reference/source-decisions/records/result-method-call-boundary.md): use
...
- Resolved by [First-Slice Grammar](../../reference/source-decisions/records/result-first-slice-grammar.md): the first
...
- Resolved by [Test Declaration Syntax](../../reference/source-decisions/records/result-test-declaration-syntax.md):
...
- Resolved by
  [Minimum Type System for Holes](../../reference/source-decisions/records/result-minimum-type-system-for-holes.md):
  ...
  let-polymorphism.
- Resolved by
  [User-Defined ADTs in the First Slice](../../reference/source-decisions/records/result-user-defined-adts-first-slice.md):
...
- Resolved by
  [Public Function Type Boundaries](../../reference/source-decisions/records/result-public-function-type-boundaries.md):
...
- Resolved by [Error Type Inference](../../reference/source-decisions/records/result-error-type-inference.md): public
...
- Resolved by
  [First-Slice Value Mutability](../../reference/source-decisions/records/result-first-slice-value-mutability.md):
...
- Resolved by
  [First Implementation Runtime Targets](../../reference/source-decisions/records/result-first-implementation-runtime-targets.md):
...
- Resolved by
  [First Implementation Architecture](../../reference/source-decisions/records/result-first-implementation-architecture.md):
...
- Resolved by
  [Channel-First Concurrency Runtime](../../reference/source-decisions/records/result-channel-first-concurrency-runtime.md):
...
- Resolved by
  [Runtime Value Freeze Boundary](../../reference/source-decisions/records/result-runtime-value-freeze-boundary.md):
...
- Resolved by
  [Contract Expression Language](../../reference/source-decisions/records/result-contract-expression-language.md):
...
- Resolved by [Contract Blame Boundary](../../reference/source-decisions/records/result-contract-blame-boundary.md):
...
- Resolved by
  [Postcondition Result Binding](../../reference/source-decisions/records/result-postcondition-result-binding.md):
  postconditions should use an explicit result binding in the return type
  position rather than a magic bare `result` name.

## Effects

- Resolved by [Effect Declaration Boundary](../../reference/source-decisions/records/result-effect-declaration-boundary.md):
...
- Resolved by [Effect Access Modes](../../reference/source-decisions/records/result-effect-access-modes.md): first-slice
...
- Resolved by
  [First-Slice Observable I/O](../../reference/source-decisions/records/result-first-slice-observable-io.md): first-slice
...
- Resolved by
  [Transitive Effect Diagnostics](../../reference/source-decisions/records/result-transitive-effect-diagnostics.md):
...
- Resolved by [Named Hole Syntax](../../reference/source-decisions/records/result-named-hole-syntax.md): first-slice
...
- Resolved by
  [Hole Satisfy Constraint Grammar](../../reference/source-decisions/records/result-hole-satisfy-constraint-grammar.md):
...
- Resolved by [Hole Runtime Boundary](../../reference/source-decisions/records/result-hole-runtime-boundary.md):
...
- Resolved by
  [Hole Diagnostic JSON Shape](../../reference/source-decisions/records/result-hole-diagnostic-json-shape.md):
...
- Resolved by [Primary Check Command](../../reference/source-decisions/records/result-primary-check-command.md):
...
- Resolved by
  [JSON Diagnostic Schema Stability](../../reference/source-decisions/records/result-json-diagnostic-schema-stability.md):
  JSON diagnostics should use a stable top-level envelope while allowing
  prototype `details` payloads to churn.
- Resolved by
  [Affected Test Selection](../../reference/source-decisions/records/result-affected-test-selection.md): before a full
...
- Resolved by
  [First-Slice Module Fields](../../reference/source-decisions/records/result-first-slice-module-fields.md):
  require
...
- Resolved by
  [ADR-Lite Decision Location](../../reference/source-decisions/records/result-adr-lite-decision-location.md):
  ...
  language syntax.
- Resolved by
  [Doctest Result Propagation](../../reference/source-decisions/records/result-doctest-result-propagation.md):
...
- Resolved by
  [Doctest Error Type Fence Syntax](../../reference/source-decisions/records/result-doctest-error-type-fence-syntax.md):
...
- Resolved by
  [Doctest Expected Output Syntax](../../reference/source-decisions/records/result-doctest-expected-output-syntax.md):
