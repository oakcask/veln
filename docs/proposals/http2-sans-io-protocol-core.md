...
- These slices move frame-kind admission and part of payload application for
  ...
  move PUSH_PROMISE, outbound content-length send accounting, outbound send
  transitions, or wider graceful-shutdown integration out of the monolithic
  case.
...
receive-frame application by moving PUSH_PROMISE, outbound content-length send
