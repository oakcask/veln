...
- generated `byte_decode_<schema>` helper bindings for format-neutral schemas
  ...
  `List<String>`, top-level `Dict<String, Int>` or `Dict<String, String>`, a
...
- generated runtime decode bindings for binary schema fields outside the
  ...
  top-level scalar list, `Dict<String, Int>` or `Dict<String, String>`,
...
- Format-neutral schemas without a `format` clause whose fields are `Int`,
  ...
  `List<Float>`, or `List<String>`, top-level `Dict<String, Int>` or
  `Dict<String, String>`, nested record shapes made from scalar field types,
...
- General schema decode can synthesize executable bindings for fields outside
  ...
  `Dict<String, Int>` or `Dict<String, String>`, supported `Option`, or nested
